...
import daily_returns_vol_pb2 as daily__returns__vol__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in daily_returns_vol_pb2_grpc.py depends on'
...
def add_DailyReturnsVolServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'get_daily_returns_vol': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=daily__returns__vol__pb2.DailyReturnsVolRequest.FromString,
                    response_serializer=daily__returns__vol__pb2.DailyReturnsVolResponse.SerializeToString,
            ),
    }
