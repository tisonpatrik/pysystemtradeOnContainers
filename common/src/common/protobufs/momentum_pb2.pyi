...
@typing.final
class MomentumRequest(google.protobuf.message.Message):
...
global___MomentumRequest = MomentumRequest

@typing.final
class MomentumResponse(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
...
global___MomentumResponse = MomentumResponse
