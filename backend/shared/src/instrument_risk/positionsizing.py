...
# def get_average_position_at_subsystem_level(instrument_code: str) -> pd.Series:
...
# def get_instrument_value_vol(instrument_code: str) -> pd.Series:
...
# def get_daily_cash_vol_target() -> float:
#     """Get the daily cash vol target.
...
# def annual_cash_vol_target() -> float:
#     notional_trading_capital = get_notional_trading_capital()
#     percentage_vol_target = get_percentage_vol_target()
...
# def get_notional_trading_capital() -> float:
#     return float(config.notional_trading_capital)


# def get_percentage_vol_target() -> float:
...
# def get_fx_rate(instrument_code: str) -> pd.Series:
