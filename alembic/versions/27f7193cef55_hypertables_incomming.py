...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_fx_prices_time'), 'fx_prices', ['time'], unique=False)
    op.create_index('ix_fx_prices_symbol', 'fx_prices', ['symbol'], unique=False)
    ...
    op.create_index('ix_adjusted_prices_time', 'adjusted_prices', ['time'], unique=False)
    ...
    op.create_index(op.f('ix_multiple_prices_time'), 'multiple_prices', ['time'], unique=False)
    ...
    op.create_index(op.f('ix_roll_calendars_time'), 'roll_calendars', ['time'], unique=False)
