...
from src.risk.models.risk_models import DailyReturnsVolatility, InstrumentVolatility
...
class RiskHandler:
    ...
    async def _get_risk_data_from_raw_file(self, model):
        ...
        if model.__tablename__ in "robust_volatility":
            return await self.daily_returns_vols_service.seed_daily_returns_volatility_for_instrument_async(
                model
            )
