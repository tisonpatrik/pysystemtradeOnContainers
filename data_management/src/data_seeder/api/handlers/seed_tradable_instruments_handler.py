...
from src.data_seeder.services.tradable_instrument_seed_service import TradableInstrumentsSeedService
...
class SeedTradableInstrumentsHandler:
    ...
    async def seed_data_async(self):
        ...
        """
        try:
            self.logger.info("Data processing for tradable instruments files has started")
            await self.tradable_instruments_service.seed_tradable_instruments_files(TradableInstrumentsSchema)
