...
output "forecasting_lambda_policy_arn" {
  value       = aws_iam_role_policy.forecasting_lambda_policy.policy_arn
  description = "The ARN of the IAM policy attached to the Forecasting domain Lambda IAM role"
}
