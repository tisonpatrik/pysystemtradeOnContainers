...
from raw_data.src.api.handlers.current_average_negskew_over_all_assets_handler import CurrentAverageNegSkewOverAllAssetsHandler
...
class HistoricAverageNegSkewAllAssetsHandler:
    ...
    async def get_historic_avg_factor_value_for_all_assets_async(self, lookback: int) -> pd.Series:
        ...
        cs_average_all_factors = (
            await self.current_average_negskew_over_all_assets_handler.get_current_avg_factor_values_for_all_assets_async(lookback=lookback)
        )
