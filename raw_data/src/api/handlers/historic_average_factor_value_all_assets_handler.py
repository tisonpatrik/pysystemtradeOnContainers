...
class HistoricAverageFactorValueAllAssetsHandler:
    ...
    async def get_historic_avg_factor_value_for_all_assets_async(self, factor_name: str, lookback: int) -> pd.Series:
        self.logger.info("Fetching historic average factor values for all assets for factor %s", factor_name)
        span_years = 15
