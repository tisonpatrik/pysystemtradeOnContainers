...
from common.src.utils.convertors import list_to_series, to_pydantic
...
class FxPricesHandler:
    ...
    async def get_standard_fx_prices_async(self, instrument_currency: str, conversion_currency: str) -> pd.Series:
        ...
        try:
            ...
            fx_prices = list_to_series(fx_prices_data, FxPrices, FxPrices.date_time, FxPrices.price)  # type: ignore[arg-type]
            return fx_prices
        except Exception as e:
