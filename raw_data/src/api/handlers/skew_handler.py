...
class SkewHandler:
    ...
    async def get_skew_async(self, symbol: str, factor_name: str, lookback: int) -> pd.Series:
        try:
    ...
    async def get_neg_skew_async(self, symbol: str, factor_name: str, lookback: int) -> pd.Series:
        try:
