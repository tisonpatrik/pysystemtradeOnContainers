...
from common.src.dependencies.core_dependencies import get_repository, get_risk_client
...
def get_normalized_price_for_asset_class_handler(
    instrument_repository: InstrumentsRepository = Depends(get_daily_vol_normalized_returns_handler),
    daily_vol_normalized_returns_handler: DailyvolNormalizedReturnsHandler = Depends(get_risk_client),
) -> NormalizedPriceForAssetClassHandler:
    return NormalizedPriceForAssetClassHandler(
