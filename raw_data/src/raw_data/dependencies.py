...
def get_daily_returns_handler() -> DailyReturnsHandler:
    prices_client = get_daily_prices_client()
    redis_repository = get_redis()
    return DailyReturnsHandler(prices_client=prices_client, redis_repository=redis_repository)


def get_daily_percentage_returns_handler() -> DailyPercentageReturnsHandler:
    prices_client = get_daily_prices_client()
    daily_returns_handler = get_daily_returns_handler()
    return DailyPercentageReturnsHandler(prices_client=prices_client, daily_returns_handler=daily_returns_handler)


def get_skew_handler() -> SkewHandler:
    daily_percentage_returns_handler = get_daily_percentage_returns_handler()
    redis_repository = get_redis()
    return SkewHandler(
...
def get_negskew_over_instrument_list_handler() -> NegSkewOverInstrumentListHandler:
    skew_handler = get_skew_handler()
    return NegSkewOverInstrumentListHandler(skew_handler=skew_handler)


def get_negskew_all_instruments_handler() -> NegSkewAllInstrumentsHandler:
    instruments_client = get_instruments_client()
    negskew_over_instrument_list_handler = get_negskew_over_instrument_list_handler()
...
def get_current_average_negskew_over_all_assets_handler() -> CurrentAverageNegSkewOverAllAssetsHandler:
    negskew_all_instruments_handler = get_negskew_all_instruments_handler()
    return CurrentAverageNegSkewOverAllAssetsHandler(negskew_all_instruments_handler=negskew_all_instruments_handler)


def get_historic_average_negskew_all_assets_handler() -> HistoricAverageNegSkewAllAssetsHandler:
    current_average_negskew_over_all_assets_handler = get_current_average_negskew_over_all_assets_handler()
...
def get_absolute_skew_deviation_handler() -> AbsoluteSkewDeviationHandler:
    historic_negskew_value_all_assets_handler = get_historic_average_negskew_all_assets_handler()
    skew_handler = get_skew_handler()
