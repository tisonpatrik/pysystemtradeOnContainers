...
from common.src.protobufs.fx_prices_pb2_grpc import FxPricesHandlerServicer
...
class FxPricesHandler(FxPricesHandlerServicer):
    def __init__(
        self,
    ...
    async def get_fx_prices(self, request: FxPricesRequest, context: ServicerContext) -> FxPricesResponse:
        ...
        try:
            instrument_currency = await self.instruments_client.get_instrument_currency_async(request.symbol)
