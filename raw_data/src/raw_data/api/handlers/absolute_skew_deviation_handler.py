...
class AbsoluteSkewDeviationHandler:
    ...
    async def get_absolute_skew_deviation_async(self, symbol: str, lookback: int) -> pd.Series:
        self.logger.info("Fetching absolute skew deviation for symbol: %s and loockback: %d", symbol, lookback)
