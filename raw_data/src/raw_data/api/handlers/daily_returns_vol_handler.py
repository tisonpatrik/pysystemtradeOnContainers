...
class DailyReturnsVolHandler:
    def __init__(self, redis: RedisClient, daily_returns_handler: DailyReturnsHandler):
    ...
    async def get_daily_returns_vol_async(self, symbol: str) -> pd.Series:
        ...
        returns = self.daily_returns_vol_service.calculate_daily_returns_vol(price_returns=daily_returns)
