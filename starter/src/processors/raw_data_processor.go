...
func AdjustedPricesProcessor(dir string, symbols [][]string, columns []string) error {
...
func MultiplePricesProcessor(dir string, symbols [][]string, columns []string) error {
	// Implement your processing logic here
...
func FXPricesProcessor(dir string, symbols [][]string, columns []string) error {
	// Implement your processing logic here
...
func RollCalendarsProcessor(dir string, symbols [][]string, columns []string) error {
	// Implement your processing logic here
