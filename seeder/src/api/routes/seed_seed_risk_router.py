...
async def seed_risk_data_async(
    seed_daily_returns_vol_service: SeedDailyReturnsVolService = Depends(get_seed_daily_returns_vol_service),
    seed_instrument_vol_service: SeedInstrumentVolService = Depends(get_seed_instrument_vol_service),
