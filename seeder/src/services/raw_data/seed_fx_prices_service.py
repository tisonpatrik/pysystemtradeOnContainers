...
from common.src.models.db_models.db_models import FxPricesModel
from common.src.queries.base_statements.insert_statement import InsertStatement
from common.src.schemas.raw_data_schemas import FxPricesSchema
...
class SeedFxPricesService:
    ...
    async def seed_fx_prices_async(self, raw_data: pd.DataFrame):
        try:
            ...
            statement = InsertStatement(table_name=FxPricesModel.__tablename__, data=validated)
